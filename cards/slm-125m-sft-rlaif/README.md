...
**125M · RLAIF** — the QA model aligned by reinforcement learning against a Bradley-Terry reward model.
...
| Compute | 5.4 min on L4 (Modal) |
| Cost | **$58.77** total lineage |
| Judge score | **3.69 / 10** |
...
MODEL = "Ace-2504/slm-125m-sft-rlaif"
...
| Metric | Value |
|---|---|
| Judge score (0–10 rubric) | **3.69** |
| Judged correctness (0–1) | 0.271 |
| Groundedness | 44.6% |
| Fabrication ↓ | 6.4% |
| Token-F1 | 0.245 |
| n | 500 |
...
- **Schedule** — 60 PPO iterations, 5.4 min on L4
...
**Cost — $58.77.** 
This line was **pretrained from scratch**, so the total includes the base: $57.79 of A100 time across four pretraining legs (v1 → extension → e2 → e4, 27.5 h at $2.10/h) plus $0.98 for this fine-tune. Models built on someone else's base do not carry that cost.
...
- **This checkpoint scores 3.69/10** — it is published for comparison across training stages, not because it is good. See the arena for why.
...
This model has its own write-up — training details, cost breakdown and live demo — at [https://slm-125m-rlaif-harman.vercel.app](https://slm-125m-rlaif-harman.vercel.app).
