...
**Gemma 2B · RLAIF** — the QA adapter aligned by reinforcement learning against a Bradley-Terry reward model.
...
| Method | QLoRA RLAIF — reward model + PPO |
...
| Compute | 36.1 min on A100-40GB (Modal) |
| Cost | **$4.73** total lineage |
| Judge score | **9.08 / 10** |
...
ADAPTER = "Ace-2504/gemma-2-2b-sft-rlaif"
...
| Metric | Value |
|---|---|
| Judge score (0–10 rubric) | **9.08** |
| Judged correctness (0–1) | 0.899 |
| Groundedness | 85.6% |
| Fabrication ↓ | 29.4% |
| Token-F1 | 0.115 |
| n | 500 |
...
- **Schedule** — 60 PPO iterations, 36.1 min on A100-40GB
...
**Cost — $4.73.** 
The base is Google's and free to build on, so only this project's own work is counted: $4.73.
...
This model has its own write-up — training details, cost breakdown and live demo — at [https://slm-gemma-rlaif-harman.vercel.app](https://slm-gemma-rlaif-harman.vercel.app).
