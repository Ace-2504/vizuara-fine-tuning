...
**500M · DPO** — the QA model aligned with Direct Preference Optimization.
...
**Cost — $1.23.** 
The base was imported, so only this project's own work is counted: $1.23 of Modal GPU time and shared dataset generation.
...
This model has its own write-up — training details, cost breakdown and live demo — at [https://slm-500m-dpo-harman.vercel.app](https://slm-500m-dpo-harman.vercel.app).
